...
export const globalErrorHandler: ErrorRequestHandler = (
  ...
  // 2. Mongoose validation errors → 422.
  ...
  // 3. Mongoose CastError (e.g. invalid ObjectId) → 400.
  ...
  // 4. MongoDB duplicate-key error → 409.
  ...
  // 5. Catch-all — hide internals in production.
